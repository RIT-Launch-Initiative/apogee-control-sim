...
simin_off = structs2inputs(simin, struct(control_mode = "const", const_brake = 0));
simin_on = structs2inputs(simin, struct(control_mode = "const", const_brake = 1)); % max braking effort
