 ...
 *
 *         single y1 = actuator_effort_lut(single u1, single u2)
 *
 *    Simulink version           : 24.2 (R2024b) 21-Jun-2024
 *    C source code generated on : 24-Sep-2025 19:17:07
 *
...
/**
     ...
     def.SFunctionName = 'LUT_C_SFunction';
     def.OutputFcnSpec = 'single y1 = actuator_effort_lut(single u1, single u2)';
     def.SourceFiles = {'\codegen\lut_only.c'};
...
#define S_FUNCTION_NAME  LUT_C_SFunction
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "actuator_effort_lut", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
